...
void DateTimeDecoratorTests::setValue_givenNewValue_updateValueAndEmitsSignal()
{
	DateTimeDecorator decorator;
...
void DateTimeDecoratorTests::jsonValue_whenDefaultValues_returnsJson()
{
	DateTimeDecorator decorator;
...
void DateTimeDecoratorTests::update_whenPresentInJson_updateValue()
{
	Entity parentEntity;
	DateTimeDecorator decorator(&parentEntity, "Test Key", "Test Label", testDate);
	QSignalSpy valueChangedSpy(&decorator, &DateTimeDecorator::valueChanged);
...
void DateTimeDecoratorTests::toIso8601String_whenValueSet_returnsString()
{
	...
	QCOMPARE(decorator.toIso8601String(), QString("2019-12-27T16:40:00"));
...
void DateTimeDecoratorTests::toPrettyDateString_whenValueSet_returnsString()
{
	...
	QCOMPARE(decorator.toPrettyDateString(), QString("27 Dec 2019"));
...
void DateTimeDecoratorTests::toPrettyString_whenValueSet_returnsString()
{
	...
	QCOMPARE(decorator.toPrettyString(), QString("Fri 27 Dec 2019 @ 16:40:00"));
}
