...
Window {
	...
	Component.onCompleted: {
		...
		console.log("ColumnWithText - implicitWidth:" + ColumnWidthText.implicitWidth + " implicitHeight:" + columnWithText.implicitHeight + " width:" + columnWithText.width + " height:" + columnWithText.height)
