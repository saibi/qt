        ...
        function addElementToComposition(shape) {
            ...
            var element = elements.factory.createObject(
                        composition.elements, {
                            ...
                            translation: Qt.vector3d( Math.random() * 3, 0.0, Math.random() * 3)
                        })
    ...
    Rectangle {
        ...
        Column {
            ...
            GroupBox {
                ...
                readonly property string shape: shapeGroup.checkedButton.objectName
            ...
            GroupBox {
                ...
                readonly property string backgroundColor: backgroundGroup.checkedButton.objectName
    ...
    FileDialog {
        ...
        onAccepted: {
            scene.grabToImage(function(image) {
                var saved = image.saveToFile((fileDialog.file + "").replace('file://', ''));
